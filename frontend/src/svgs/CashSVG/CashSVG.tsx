import styles from "./CashSVG.module.scss"

export const CashSVG = ({ className }: { className: string }) => {
  return (
    <svg className={styles.cashSVG} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' fill="#e8e6e3">
