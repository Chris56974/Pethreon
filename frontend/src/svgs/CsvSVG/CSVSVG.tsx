import styles from "./CsvSVG.module.scss"

interface CsvSVGProps {
  className?: string
}

export const CsvSVG = ({ className }: CsvSVGProps) => {
  return (
    <svg className={styles.csvSVG} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
