import styles from "./PledgeSVG.module.scss"

interface PledgeSVGProps {
  className?: string
}

export const PledgeSVG = ({ className }: PledgeSVGProps) => {
  return (
    <svg className={styles.PledgeSVG} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
