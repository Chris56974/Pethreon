...
export const Metamask: React.FC = () => {
  return (
    <svg viewBox="0 0 154 154" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="metamask-fox 1">
        <path id="Vector" d="M132.49 17.1594L84.3955 52.8801L93.2894 31.8054L132.49 17.1594Z" fill="#E2761B" stroke="#E2761B" strokeLinecap="round" strokeLinejoin="round" />
        <g id="Group">
          <path id="Vector_2" d="M21.4614 17.1594L69.1695 53.2184L60.7106 31.8054L21.4614 17.1594Z" fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_3" d="M115.186 99.9598L102.377 119.584L129.783 127.125L137.662 100.395L115.186 99.9598Z" fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_4" d="M16.3861 100.395L24.2166 127.125L51.6234 119.584L38.8142 99.9598L16.3861 100.395Z" fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_5" d="M50.0766 66.801L42.4395 78.3534L69.6529 79.5618L68.6862 50.3182L50.0766 66.801Z" fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_6" d="M103.875 66.801L85.0239 49.9799L84.3955 79.5618L111.561 78.3534L103.875 66.801Z" fill="#E4761B" stroke="#E4761B" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <path id="Vector_7" d="M67.091 93.5311L53.4601 89.5192L63.0791 85.1205L67.091 93.5311Z" fill="#233447" stroke="#233447" strokeLinecap="round" strokeLinejoin="round" />
        <path id="Vector_8" d="M86.8606 93.5311L90.8726 85.1205L100.54 89.5192L86.8606 93.5311Z" fill="#233447" stroke="#233447" strokeLinecap="round" strokeLinejoin="round" />
        <g id="Group_3">
          ...
          <path id="Vector_9" d="M111.561 78.3535L84.3955 79.5619L86.909 93.5311L90.9209 85.1206L100.588 89.5192L111.561 78.3535Z" fill="#CD6116" stroke="#CD6116" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_10" d="M53.4602 89.5192L63.1275 85.1206L67.0911 93.5311L69.6529 79.5619L42.4395 78.3535L53.4602 89.5192Z" fill="#CD6116" stroke="#CD6116" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <g id="Group_4">
        ...
        <g id="Group_5">
          <path id="Vector_11" d="M134.52 55.2002L138.629 35.4789L132.49 17.1594L85.9906 51.6717L103.875 66.801L129.155 74.1965L134.762 67.671L132.345 65.9309L136.212 62.4024L133.215 60.0822L137.082 57.1337L134.52 55.2002Z" fill="#763D16" stroke="#763D16" strokeLinecap="round" strokeLinejoin="round" />
          <path id="Vector_12" d="M15.371 35.4789L19.4796 55.2002L16.8694 57.1337L20.7364 60.0822L17.7878 62.4024L21.6547 65.9309L19.2379 67.671L24.7966 74.1965L50.0766 66.801L67.9611 51.6717L21.4614 17.1594L15.371 35.4789Z" fill="#763D16" stroke="#763D16" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <path id="Vector_13" d="M129.155 74.1965L103.875 66.801L111.561 78.3534L100.105 100.588L115.186 100.395H137.662L129.155 74.1965Z" fill="#F6851B" stroke="#F6851B" strokeLinecap="round" strokeLinejoin="round" />
        <path id="Vector_14" d="M50.0766 66.801L24.7966 74.1965L16.3861 100.395H38.8142L53.8468 100.588L42.4394 78.3534L50.0766 66.801Z" fill="#F6851B" stroke="#F6851B" strokeLinecap="round" strokeLinejoin="round" />
